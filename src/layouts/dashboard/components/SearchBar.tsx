    ...
    return (
        <>
            <div className="flex items-center justify-center">
                <IconButton className="h-10 w-20" onClick={handleOpen}>
                    <SvgIcon iconClass="ic-search" fontSize="20" />
                    <IconButton className="ml-2 h-6 rounded-md bg-hover text-xs font-bold">
                        ⌘K
                    </IconButton>
                </IconButton>
            </div>
            <Modal
                ...
                title={
                    <Input
                        ...
                        bordered={false}
                        autoFocus
                        prefix={<SvgIcon iconClass="ic-search" fontSize="20" />}
                        suffix={
                            <IconButton
